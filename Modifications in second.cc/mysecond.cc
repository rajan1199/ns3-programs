...
main (int argc, char *argv[])
{
  ...
  pointToPoint.EnablePcapAll ("mysecond_p2p");
  csma.EnablePcapAll ("mysecond_csma");
  ...
  anim.SetConstantPosition(csmaNodes.Get(4),60.0,20.0);

	/******************************************************************/

  AsciiTraceHelper ascii;
  pointToPoint.EnableAsciiAll(ascii.CreateFileStream("mysecond_p2p.tr"));
  csma.EnableAsciiAll(ascii.CreateFileStream("mysecond_csma.tr"));
